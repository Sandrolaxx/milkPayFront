...
export default function Dashboard({ cardsData, titleListData }: DashboardProps) {
    const isLoadingCards = cardsData == undefined;
    const isLoadingTitleList = titleListData == undefined;
