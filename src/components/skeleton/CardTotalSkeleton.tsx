        ...
        <div className="w-full h-16 p-2 shadow-md border-2 rounded-3xl sm:h-24 xl:mt-4 lg:m-2 xl:h-32 animate-fade-left md:animate-fade-down">
            <div className="flex justify-between w-full">
                ...
                <div className="flex flex-col">
                    <div className="w-28 h-4 self-end animate-pulse bg-gray-300 rounded-sm mr-1 xl:mr-0 xl:h-6">
                    </div>
                    <div className="w-16 h-4 self-end animate-pulse bg-gray-300 rounded-sm mt-2 mr-1 xl:mr-0 xl:h-6">
                    </div>
                </div>
            </div>
